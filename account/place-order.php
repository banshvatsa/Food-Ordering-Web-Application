...
?>
  ...
  <body>
      ...
      <div class="navbar-fixed">
        <nav class="navbar-color">
          <div class="nav-wrapper">
            <ul class="left">
              <li>
                <h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/logo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1>
              </li>
            </ul>
    ...
    <div id="main">
      ...
      <div class="wrapper">
        ...
        <section id="content">
          ...
          <div class="container">
            <p class="caption">Stripe Payment Integration</p>
            <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Stripe Payment</h4>
              </div>
              <div>
                <div class="card-panel">
                  <div class="row">
                    <form id="stripe-payment-form" method="post" action="stripe-confirm.php">
                      <div class="row">
                        <!-- Stripe Card Element -->
                        <div class="input-field col s12">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <button class="btn cyan waves-effect waves-light right" type="submit">Pay with Stripe</button>
                        </div>
                      </div>
                    </form>
                  </div>
    ...
    <script>
      // Initialize Stripe
      const stripe = Stripe('pk_test_51QMvNkDv0X7rsbGmxLzf7R86PIzVgm6FBRkzpY3cZdtckSqHbonYNqLRXBeZcf6KoClck3CdwwzWEkkmegkpusXw00ifNHKdCC'); // Replace with your Test Publishable Key
      const elements = stripe.elements();
      const card = elements.create('card');
      card.mount('#stripe-card-element'); // Mount to the new card element
